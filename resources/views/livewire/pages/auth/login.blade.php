...
<div>
    ...
    <div class="mt-7 bg-white border border-gray-100 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-700">
              ...
              <div class="grid gap-y-4">
                ...
                <div>
                  ...
                  <div class="relative">
                      ...
                      <x-input-label for="email" :value="__('Email')" name="email" class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required aria-describedby="email-error" />
                      <x-text-input wire:model="form.email" id="email" class="block mt-1 w-full" type="email" name="email" required autofocus autocomplete="username" />
                      <x-input-error :messages="$errors->get('form.email')" class="mt-2" />
                ...
                <div>
                  ...
                  <div class="relative">
                    <x-input-label for="password" :value="__('Password')"  class="block text-sm mb-2 dark:text-white"/>
                ...
                <div class="flex items-center">
                  ...
                  <div class="ms-3">
                    <label for="remember-me" class="text-sm dark:text-white"> Recordarme</label>
                  </div> --}}
                </div>
                <!-- End Checkbox -->
